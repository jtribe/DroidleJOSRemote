...
/**
 * This class has been designed to manage the device MSC8, Mindsensors NXT Servo
 * which manages up to 8 RC Servos.
 * 
 * For example, do:
 * 
...
public class MSC extends I2CSensor {
	...
	public static final byte MSC8_VBATT = 0x41;// The I2C Register to read the
	// battery
	 ...
	 * 
	 * @param location
	 *            location of the servo (from 1 to 8)
